/*
 *  Sends health related sensor readings to the provided URL
 ...
 *  References
 * https://github.com/me-no-dev/ESPAsyncWebServer - "simple_server" example
 * https://github.com/milesburton/Arduino-Temperature-Control-Library - "Simple" example
 * https://github.com/adafruit/DHT-sensor-library - "DHTTester" example
 * https://github.com/sparkfun/SparkFun_MAX3010x_Sensor_Library - "Example8_SPO2" example
 * https://github.com/adafruit/Adafruit_MPU6050 - "basic_readings" example
 *
 */
#include "DHT.h"
#include <WiFi.h>
...
const char* password = "myesp32";

// SSID and Password for the WiFi. This is kept blank because it will be populated from 
...
const char* FALL_DETAILS_URL = "";			// POST API for fall detection
const char* SENSOR_DATA_URL = "";			// POST API for all sensor readings
